...
def RF_predict(ifile1,ifile2,ofile1,ofile2,Nest,Crt,MaxFeat):
    ...
    y_test,y_pred_prob,y_pred,auc,acc2,mcc,Recall,Precision,F1_score=rf(X_Train,Y_Train,x_test,y_test,Nest,Crt,MaxFeat)
...
if __name__ == '__main__':
    RF_predict("/Path to train file/train.csv",
    "/Path to validation set/Validation_Set/validation.csv"
    ,"RF_Validation_Predictions.csv","RF_Validation_Metrics.csv",100,"entropy","sqrt")
