...
def BNB_predict(ifile1,ifile2,ofile1,ofile2,a,binz,cl_pr,ft_pr):
    ...
    y_test,y_pred_prob,y_pred,auc,acc2,mcc,Recall,Precision,F1_score=BernoulNB(X_Train, Y_Train, x_test, y_test,a,binz,cl_pr,ft_pr)
...
if __name__ == '__main__':
    BNB_predict("/Path to /Train set",
    "Path to validation set/Validation/validation.csv"
    ,"Path to output predictions/NB_Validation_Predictions.csv","Path to output metrics/NB_Validation_Metrics.csv",0.1,0,None,False)
